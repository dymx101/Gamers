...
public class YouTubePlayerView: UIView, UIWebViewDelegate {
    ...
    private func playerHTMLPath() -> String {
        //return NSBundle(forClass: self.classForCoder).pathForResource("YTPlayerView-iframe-player", ofType: "html")!
        return NSBundle.mainBundle().pathForResource("YTPlayerView-iframe-player", ofType: "html")!
    }
